...
var ApolloClient = (function () {
    function ApolloClient(_a) {
        var _this = this;
        var _b = _a === void 0 ? {} : _a, networkInterface = _b.networkInterface, reduxRootKey = _b.reduxRootKey, reduxRootSelector = _b.reduxRootSelector, initialState = _b.initialState, dataIdFromObject = _b.dataIdFromObject, resultTransformer = _b.resultTransformer, resultComparator = _b.resultComparator, _c = _b.ssrMode, ssrMode = _c === void 0 ? false : _c, _d = _b.ssrForceFetchDelay, ssrForceFetchDelay = _d === void 0 ? 0 : _d, _e = _b.mutationBehaviorReducers, mutationBehaviorReducers = _e === void 0 ? {} : _e, _f = _b.addTypename, addTypename = _f === void 0 ? true : _f, queryTransformer = _b.queryTransformer;
...
},{"./core/QueryManager":4,"./data/storeUtils":11,"./fragments":14,"./queries/getFromAST":19,"./store":23,"./transport/networkInterface":26,"lodash.assign":36,"lodash.isstring":47,"lodash.isundefined":48}],2:[function(require,module,exports){
"use strict";
...
},{"../errors/ApolloError":13,"../queries/getFromAST":19,"../queries/store":21,"../util/Observable":27,"../util/errorHandling":28,"./QueryManager":4,"lodash.assign":36,"lodash.isequal":43}],4:[function(require,module,exports){
"use strict";
...
},{"../data/readFromStore":6,"../data/resultReducers":8,"../errors/ApolloError":13,"../queries/getFromAST":19,"../queries/queryTransform":20,"../queries/store":21,"../scheduler/scheduler":22,"../store":23,"../util/Observable":27,"../util/errorHandling":28,"./ObservableQuery":3,"graphql-tag/printer":35,"lodash.forown":40,"lodash.isequal":43}],5:[function(require,module,exports){
"use strict";
...
},{"../queries/getFromAST":19,"./replaceQueryResults":7,"./scopeQuery":9,"./writeToStore":12,"lodash.assign":36,"lodash.clonedeep":37,"lodash.mapvalues":49}],6:[function(require,module,exports){
(function (process){
"use strict";
...
},{"../queries/getFromAST":19,"./storeUtils":11,"_process":62,"graphql-anywhere":31}],7:[function(require,module,exports){
"use strict";
var writeToStore_1 = require('./writeToStore');
var assign = require('lodash.assign');
...
},{"./writeToStore":12,"lodash.assign":36}],8:[function(require,module,exports){
"use strict";
...
},{"./readFromStore":6,"./writeToStore":12}],9:[function(require,module,exports){
"use strict";
var storeUtils_1 = require('./storeUtils');
...
},{"./storeUtils":11,"lodash.isnumber":45}],10:[function(require,module,exports){
"use strict";
...
},{"../actions":2,"./mutationResults":5,"./replaceQueryResults":7,"./storeUtils":11,"./writeToStore":12,"lodash.assign":36}],11:[function(require,module,exports){
"use strict";
...
},{"lodash.isobject":46}],12:[function(require,module,exports){
"use strict";
...
},{"../queries/directives":18,"../queries/getFromAST":19,"./storeUtils":11,"lodash.assign":36,"lodash.isnull":44,"lodash.isobject":46,"lodash.isundefined":48}],13:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./queries/getFromAST":19,"lodash.flatten":39}],15:[function(require,module,exports){
"use strict";
var networkInterface_1 = require('./transport/networkInterface');
...
},{"./ApolloClient":1,"./core/ObservableQuery":3,"./data/readFromStore":6,"./data/writeToStore":12,"./errors/ApolloError":13,"./fragments":14,"./queries/getFromAST":19,"./store":23,"./transport/batchedNetworkInterface":24,"./transport/networkInterface":26,"graphql-tag/printer":35}],16:[function(require,module,exports){
"use strict";
var actions_1 = require('../actions');
var assign = require('lodash.assign');
...
},{"../actions":2,"lodash.assign":36}],17:[function(require,module,exports){
"use strict";
var actions_1 = require('../actions');
...
},{"../actions":2,"../data/store":10,"../store":23,"lodash.assign":36,"lodash.pick":51}],18:[function(require,module,exports){
"use strict";
...
},{"lodash.assign":36,"lodash.countby":38,"lodash.identity":41}],20:[function(require,module,exports){
"use strict";
...
},{"./getFromAST":19,"lodash.clonedeep":37}],21:[function(require,module,exports){
"use strict";
var actions_1 = require('../actions');
var storeUtils_1 = require('../data/storeUtils');
var assign = require('lodash.assign');
...
},{"../actions":2,"../data/storeUtils":11,"lodash.assign":36,"lodash.isequal":43}],22:[function(require,module,exports){
"use strict";
var QueryManager_1 = require('../core/QueryManager');
var ObservableQuery_1 = require('../core/ObservableQuery');
var assign = require('lodash.assign');
var QueryScheduler = (function () {
    ...
    QueryScheduler.prototype.startPollingQuery = function (options, queryId, firstFetch, listener) {
        ...
        if (firstFetch) {
            this.fetchQuery(queryId, options, QueryManager_1.FetchType.normal);
        }
        if (listener) {
...
},{"../core/ObservableQuery":3,"../core/QueryManager":4,"lodash.assign":36}],23:[function(require,module,exports){
"use strict";
...
},{"./data/store":10,"./mutations/store":16,"./optimistic-data/store":17,"./queries/store":21,"lodash.assign":36,"redux":68}],24:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./batching":25,"./networkInterface":26,"lodash.assign":36,"lodash.isnumber":45,"whatwg-fetch":73}],25:[function(require,module,exports){
"use strict";
;
...
},{"graphql-tag/printer":35,"lodash.assign":36,"lodash.isstring":47,"lodash.mapvalues":49,"whatwg-fetch":73}],27:[function(require,module,exports){
"use strict";
...
},{"symbol-observable":70}],28:[function(require,module,exports){
"use strict";
...
},{"lodash.assign":36,"lodash.countby":38,"lodash.identity":41}],31:[function(require,module,exports){
"use strict";
var getFromAST_1 = require('./getFromAST');
...
},{"./directives":29,"./getFromAST":30,"./storeUtils":32,"lodash.isnull":44,"lodash.isundefined":48,"lodash.merge":50}],32:[function(require,module,exports){
"use strict";
...
},{"lodash.includes":42}],33:[function(require,module,exports){
...
},{"./parser":34}],34:[function(require,module,exports){
module.exports =
...
},{"./createStore":67,"./utils/warning":69,"_process":62,"lodash/isPlainObject":61}],66:[function(require,module,exports){
"use strict";
...
},{"lodash/isPlainObject":61,"symbol-observable":70}],68:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./applyMiddleware":63,"./bindActionCreators":64,"./combineReducers":65,"./compose":66,"./createStore":67,"./utils/warning":69,"_process":62}],69:[function(require,module,exports){
'use strict';
...
},{"apollo-client":15,"graphql-tag":33}]},{},[74]);
